...
public abstract class CommandArguement {
    ...
    public CommandArguement(String name, String description) {
        this(name, description, (String)null);
    }

    public CommandArguement(String name, String description, String permission) {
        this(name, description, permission, ArrayUtils.EMPTY_STRING_ARRAY);
    }

    public CommandArguement(String name, String description, String[] aliases) {
        this(name, description, null, aliases);
    }

    public CommandArguement(String name, String description, String permission, String[] aliases) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommandArguement)) {
            return false;
        }
        CommandArguement that = (CommandArguement)o;
